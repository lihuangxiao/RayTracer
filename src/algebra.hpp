  ...
  Intersection & operator= (const Intersection & other)
    {
        ...
        {
          exist = other.exist;
          point = Point3D(other.point);
          normal = Vector3D(other.normal);
...
/*
Intersection planeintersect(Point3D p, Vector3D n, Point3D eye, Point3D pixel) {
  Intersection i;
  i.exist = false;
  return i;
}
